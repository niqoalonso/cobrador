...
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Anulación Posturas</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                ...
                                <tbody class="body-anulacion">
                                    @foreach ($data as $item)
                                        <tr>    
                                            <td>{{$item->arriendo->empresa->rut}}</td>
                                            ...
                                            <td class="text-center">
                                                <a href="javascript:void(0)" class="text-info p-2" onclick="verDetallePostura(this.id)" id="{{$item->sku}}" ><i class="fa fa-list-alt"></i></a>
                                                <a href="javascript:void(0)" class="text-success p-2" onclick="confirmarAnulacion(this.id)" id="{{$item->id_postura}}"><i class="fa fa-check-circle"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
    ...
    <div class="modal fade" id="modalAnularPostura" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Aceptación Anulación Postura</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
...
@section('js')
    ...
    <script src="{{asset('pages/js/anulacionPostura.js')}}"></script>
